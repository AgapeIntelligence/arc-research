...
if not DATA_PATH.exists():
    try:
        ...
        tasks = [
            ...
            {"name": "pattern", "test": [{"input": [[0,1,0],[1,1,1],[0,1,0]],
...
# ===================================================================
# Section 4: Hopf + Ethical Initialization
# ===================================================================
...
for i, task in enumerate(tasks):
    try:
        ...
        if (i+1) % 5 == 0 or (i+1) == len(tasks):
            print(f"{i+1}/{len(tasks)} | Task: {task.get('name', 'N/A')} | Solved: {solved} | Ethical: {ethics['ethical_score']:.3f}")

    except Exception as e:
        print(f"Task {task.get('name', 'N/A')} failed: {e}")
